...
public class FeatureFlagsCase extends Methods {

    private static final String JSONS_PATH = "JSONs/ZK/";

    public static HttpRequestActionBuilder UC01_GET_v2_feature_flags =
            http("UC01_GET_/api/v2/feature-flags")
    ...
    public static HttpRequestActionBuilder UC02_POST_v2_feature_flags =
            http("UC02_POST_/api/v2/feature-flags")
    ...
    // Низконагружен не попал в профиль
    public static HttpRequestActionBuilder UC03_PATCH_v2_feature_flags_batch_identical =
            http("UC03_PATCH_/api/v2/feature-flags/batch-identical")
                    .patch("/api/v2/feature-flags/batch-identical")
                    .body(ElFileBody(JSONS_PATH + "shared/FeatureFlagApiModel_body.json"))
                    .queryParam("filter", Methods.queryFromFile(JSONS_PATH + "shared/PagingRequestExt_filter.json"))
                    .headers(Headers.getCommonHeaders())
                    .check(status().is(200));
